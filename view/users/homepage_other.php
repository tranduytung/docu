...
?>
    ...
    <?php
        ...
        while($product = mysql_fetch_array($p)){
            if($product["access_level"]=="Mọi người"){
    ?>
    <div id="product_list" >
        ...
        <div>
            ...
            <div class="product_option">
                <ul>
                        ...
                        <a href="<?php echo SITE_PATH;?>index.php?controller=exchange&action=change&product_id=<?php echo $product["id"]; ?>"><li>Trao Đổi</li></a>                       
                        <a href="<?php echo SITE_PATH;?>index.php?controller=product&action=bookmark&product_id=<?php echo $product["id"]; ?>"><li>Đánh Dấu</li></a>
                </ul>
            </div>
        </div>
    </div>
