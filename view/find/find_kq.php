...
?>
    ...
    if(mysql_num_rows($p)==0){
        echo "<h3>Không tìm thấy sản phẩm nào liên quan<h3>";
    }
    ...
    <div id="product_list" >
        ...
        <div>
            ...
            <div class="product_option">
               <ul>
                        <a href="<?php echo SITE_PATH;?>index.php?controller=product&action=view&user_id=<?php echo $p["user_id"]; ?>&product_id=<?php echo $product["id"]; ?> "><li>Xem</li></a>
                        <?php if($product["user_id"]==$_SESSION["user_id"]) {?>
                        <a href="<?php echo SITE_PATH;?>index.php?controller=product&action=edit&user_id=<?php echo $p["user_id"]; ?>&product_id=<?php echo $product["id"]; ?>"><li>Sửa</li></a>
                        <?php
                            }
                            else{ ?>
                        ...
                        ?>
                        <?php if($product["user_id"]==$_SESSION["user_id"]) {?>
                        <a href="<?php echo SITE_PATH;?>index.php?controller=product&action=delete&user_id=<?php echo $p["user_id"]; ?>&product_id=<?php echo $product["id"]; ?>"><li>Xóa</li></a>
                        <?php
                            }
                            else{ ?>
