...
?>
    ...
    <br />
        <h3 class="green">Vui lòng xem lại 2 sản phẩm bạn muốn trao đổi</h3>
        <h3 class="green"><?php echo $error?></h3>
        <form method="POST">
            <input class="btn" type="submit" name="back" value="Quay lại" />
            <input class="btn" type="submit" name="next" value="Tiếp tục" />
        </form>
    </div>
    </div>
</div>
