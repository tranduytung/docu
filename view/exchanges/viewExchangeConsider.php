        ...
        <div id="table-div">
            ...
            <div id="exchange_view">
                ...
                <div style="text-align: center;">
                    ...
                    <?php if($error!=""){
                        echo "<h3  class='green'>".$error."</h3>";
                        echo "<form method='POST''><input class='btn' type='submit' name='cancle' value='Hủy' /></form>";
                    }
                    else{ ?>
                    <h3  class="green">Click Đồng ý để tiếp tục giao dịch. Hủy để hủy giao dịch</h3>
                    <form method="POST">
                        <input class="btn" type="submit" name="ok" value="Đồng Ý" />
                        <input class="btn" type="submit" name="cancle" value="Hủy" />
                    </form>
                    <?php } ?>
                </div>
            </div>    
